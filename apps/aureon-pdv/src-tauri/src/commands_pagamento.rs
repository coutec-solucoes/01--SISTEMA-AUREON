...
pub async fn registrar_pagamento(
    ...
    crate::commands_seguranca::garantir_permissao_usuario(&conn, "VENDA_FINALIZAR", Some(&dto.venda_id), None)?;
...
pub async fn finalizar_venda(
    ...
    // GUARDA DE PERMISSÃO OPERACIONAL
    crate::commands_seguranca::garantir_permissao_usuario(&conn, "VENDA_FINALIZAR", Some(&venda_id), None)?;
