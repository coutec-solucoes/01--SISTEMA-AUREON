...
pub fn criar_app(pool: Option<PgPool>) -> Router {
    ...
    let rotas_protegidas = Router::new()
        ...
        .route("/fiscal/assinatura/assinar-xmldsig-homologacao", post(fiscal_ass_xml::assinar_xmldsig_homologacao))
        ...
        // Validação Local de Schemas Preview (Fase 18 - Bloco 5)
        ...
        // Checklist de Prontidão Técnica (Fase 19 - Bloco 9)
